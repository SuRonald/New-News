...
const SelectedCategory = () => {
    ...
    // Note: Link API untuk categoty = http://api.mediastack.com/v1/news?access_key=82911763eb8f145de0c286180df1661f&languages=en&categories=
    const url = "http://api.mediastack.com/v1/news?access_key=82911763eb8f145de0c286180df1661f&languages=en&categories=" + category;
    console.log(url);
