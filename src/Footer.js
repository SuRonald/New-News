...
const Footer = () => {
    return (
        <div className="text-center text-lg-start bg-dark text-white">
                ...
                <div>
                    <ul className="list-unstyled list-inline text-center">
                        <li className="list-inline-item">
                            <a className="btn-floating mx-1" href="https://www.facebook.com/">
                        ...
                        <li className="list-inline-item">
                            <a className="btn-floating mx-1" href="https://twitter.com/?lang=en">
                        ...
                        <li className="list-inline-item">
                            <a className="btn-floating mx-1" href="https://www.google.com/">
                        ...
                        <li className="list-inline-item">
                            <a className="btn-floating mx-1" href="https://www.instagram.com/">
                        ...
                        <li className="list-inline-item">
                            <a className="btn-floating mx-1" href="https://www.linkedin.com/feed/">
                        ...
                        <li className="list-inline-item">
                            <a className="btn-floating mx-1" href="https://github.com/">
            ...
            <div className="container p-4">
                <div className="row">
                    ...
                    <Link to="/" className="d-flex mb-3 mb-lg-0 me-lg-auto text-decoration-none">
                        <img src={Logo} alt="Logo" className="newlogo footer-logo" />
                    </Link>
                    ...
                    <div className="col-lg-6 col-md-12 mb-4 mb-md-0">
                        ...
                        <p>Applikasi New-News! ini dibuat menggunakan <a href="https://reactjs.org/">React</a> dan berita berita yang didapatkan diambil dari API <a href="https://mediastack.com/">MediaStack</a>.</p>
                    </div>
                </div>
            </div>

            <div className="text-center p-4 cpy-right">
                <h5>© 2021 Copyright: New-News!</h5>
            </div>
        </div>
    );
}
