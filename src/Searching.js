...
const SelectedCategory = () => {
    ...
    // Note: Link API untuk keywords = http://api.mediastack.com/v1/news?access_key=82911763eb8f145de0c286180df1661f&languages=en&keywords=
    const url = "http://api.mediastack.com/v1/news?access_key=82911763eb8f145de0c286180df1661f&languages=en&keywords=" + keywords;
    console.log(url);
